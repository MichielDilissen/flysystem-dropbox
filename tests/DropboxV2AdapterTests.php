...
use League\Flysystem\Dropbox\DropboxV2Adapter as Dropbox;
...
class DropboxTests extends PHPUnit_Framework_TestCase
{
    ...
    {
        $mock->upload(Argument::any(), Argument::any(), Argument::any(), null)->willReturn([
            'is_dir'    => false,
            'modified'  => '10 September 2000',
            'path'      => '/prefix/something'
        ], false);
    ...
    public function testRead($adapter, $mock)
    {
        ...
        $mock->download(Argument::any(), Argument::any())->willReturn($stream, false);
    ...
    {
        $mock->listFolder(Argument::type('string'))->willReturn(
            ['contents' => [
    ...
    {
        $mock->move('/prefix/something', '/prefix/something')->willThrow(new DropboxClientException('Message'));
    ...
    {
        $mock->copy(Argument::any(), Argument::any())->willThrow(new DropboxClientException('Message'));
    ...
    {
        $this->assertInstanceOf('Kunnu\Dropbox\Dropbox', $adapter->getClient());
    }
}
